...
| --------------------------- | ---------------------- | --------------------------------------------------------- |
| situacao_epidemiologica.csv | CSV (Folha de cálculo) | Situação epidemiológica para cada um dos dias             |
| confirmados_concelho.csv    | CSV (Folha de cálculo) | Número de casos para cada concelho, para cada um dos dias |
| covid-pt-2020-03-30.gpkg    | GeoPackage (QGIS)      | Além das tabelas anteriores, contém os polígonos dos concelhos |
...
Sendo este um repositório aberto à participação, queremos eliminar os erros nos dados com a ajuda de todos. Se encontrar alguma erro, por favor crie um *issue*.